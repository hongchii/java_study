...
public class EventActionListener implements ActionListener {
	...
	public void insert() {
		...
		if (flag == 0) {
			...
			model.addRow(arr);
//			System.out.println("학번" + obj.hakbun +"추가성공!");
			JOptionPane.showMessageDialog(null, "학번" + obj.hakbun + "추가 성공!");

		} else
//		System.out.println("학번" + obj.hakbun +"중복 오류로 추가 실패!");
			JOptionPane.showMessageDialog(null, "학번" + obj.hakbun + "중복 오류로 추가 실패!");
	...
	public void delete() {
		...
		model.removeRow(row);
//		System.out.println("학번" + obj.hakbun +"삭제 성공!");		
		JOptionPane.showMessageDialog(null, "학번" + hakbun + "삭제 성공!");
	}
	...
	public void update() {
		...
		if (flag == 0) {
			JOptionPane.showMessageDialog(null, "학번" + obj.hakbun + "수정 실패!");
		} else
			JOptionPane.showMessageDialog(null, "학번" + obj.hakbun + "수정 성공!");
